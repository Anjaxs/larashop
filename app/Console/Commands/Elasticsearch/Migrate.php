...
class Migrate extends Command
{
    ...
    public function handle()
    {
        ...
        $indices  = array_map(
            function ($filename) {
                return 'App\Console\Commands\Elasticsearch\Indices\\' . str_replace(strrchr($filename, "."), "", $filename);
            },
            array_filter(scanDir('app/Console/Commands/Elasticsearch/Indices'), function ($path) {
                return $path != '.' && $path != '..';
            })
        );
        // 遍历索引类数组
